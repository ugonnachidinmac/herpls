...
const SignUp = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-background px-4 py-6">
      {/* Left: Form */}
      <div className="bg-white shadow-2xl rounded-lg mt-[24px] p-8 w-full max-w-lg">
        {/* Arrow and Heading */}
        <div className="mb-4 flex gap-[15px] items-center justify-between">
          ...
          <h2 className="w-[250px] text-1xl md:text-3xl font-bold text-headers px-4 py-3 border border-headers text-center rounded-[12px] mx-auto">
            Agent Sign Up
          </h2>
        </div>
