  ...
  return (
    <section className="bg-white w-full rounded-xl shadow-md p-4 mb-6">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 text-headers font-semibold text-lg cursor-pointer hover:text-headers transition">
          {currentRoute.icon}
        ...
        <div className="flex items-center gap-4 sm:gap-6 flex-wrap justify-center md:justify-end text-neutral-700">
          <p className="font-medium text-sm hover:text-headers cursor-pointer">
            Approved
          </p>

          {/* Notification Bell */}
          <div className="relative cursor-pointer text-xl hover:text-headers transition">
            <FaRegBell />
          ...
          <div className="relative">
            ...
            >
              <img
                ...
                alt="User"
                className="w-8 h-8 rounded-full object-cover border border-headers"
              />
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                <ul className="py-1 text-sm text-neutral-700">
                  <li className="flex items-center gap-2 px-4 py-2 hover:bg-headers hover:text-white cursor-pointer">
                  ...
                  <li
                    className="flex items-center gap-2 px-4 py-2 hover:bg-headers hover:text-white cursor-pointer"
