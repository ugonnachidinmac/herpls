...
const Footer = () => {
  return (
    <footer className="bg-headers text-white px-6 sm:px-6 md:px-12 lg:px-20 py-10 overflow-hidden">
      <div className="flex flex-col lg:flex-row flex-wrap gap-12 lg:gap-24 max-w-[1440px] mx-auto">
        ...
        <div className="flex-1 min-w-[250px]">
         ...
         <p className="mt-4 text-sm md:text-base lg:text-[18px] font-light max-w-[70%] lg:max-w-[480px]">
          ...
          <div className="flex gap-6 mt-5 text-buttons text-xl">
        ...
        <div className="flex flex-col mt-4 lg:mt-0 min-w-[180px]">
          <h3 className="font-extrabold text-[20px] md:text-[22px] text-buttons tracking-widest">
            Links
          </h3>
          <ul className="mt-3 text-[16px] md:text-[18px] tracking-wide font-bold space-y-3">
  <li>
    <Link to="/" className="hover:border hover:border-buttons px-3 py-2 w-fit inline-block">
      Home
    </Link>
  </li>
  <li>
    <Link to="/about" className="hover:border hover:border-buttons px-3 py-2 w-fit inline-block">
      About Us
    </Link>
  </li>
  <li>
    <Link to="/chart" className="hover:border hover:border-buttons px-3 py-2 w-fit inline-block">
      View Chart
    </Link>
  </li>
  <li>
    <Link to="/agents" className="hover:border hover:border-buttons px-3 py-2 w-fit inline-block">
      Agents
    </Link>
  </li>
</ul>
        ...
        <div className="flex flex-col mt-4 lg:mt-0 min-w-[220px]">
          ...
          <ul className="mt-3 text-[16px] md:text-[18px] tracking-wide font-bold space-y-3 cursor-pointer">
            <li className="hover:border hover:border-buttons px-3 py-2 w-fit">Teams</li>
            <li className="hover:border hover:border-buttons px-3 py-2 w-fit">Gallery</li>
            <li className="hover:border hover:border-buttons px-3 py-2 w-fit">Terms & Conditions</li>
            <li className="hover:border hover:border-buttons px-3 py-2 w-fit">Privacy Policy</li>
          </ul>
        </div>
      </div>

      {/* Bottom Bar */}
      <div className="text-center border-t border-buttons mt-10 pt-4">
        <p className="text-buttons text-sm">
